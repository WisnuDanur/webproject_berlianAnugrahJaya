...
<html data-bs-theme="light" lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <!--    Favicons-->
    <!-- ===============================================-->
    <link rel="apple-touch-icon" sizes="180x180" href="<?= base_url(); ?>assets/assets/img/favicons/apple-touch-icon.png">
    <link rel="icon" type="image/png" sizes="32x32" href="<?= base_url(); ?>assets/assets/img/favicons/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="16x16" href="<?= base_url(); ?>assets/assets/img/favicons/favicon-16x16.png">
    ...
    <link href="<?= base_url(); ?>assets/assets/css/theme.css" rel="stylesheet" id="style-default">
    <link href="<?= base_url(); ?>assets/assets/css/user-rtl.css" rel="stylesheet" id="user-style-rtl">
    <link href="<?= base_url(); ?>assets/assets/css/user.css" rel="stylesheet" id="user-style-default">
